package tutorialJava.capitulo8_AWT_SWING.ejercicios.ejercicio04_CentroEducativoSegundaParte.entidades;
...
public class Estudiante {
	...
	public Estudiante(int id, String nombre, String apellido1, String apellido2, String dni, String direccion,
			String email, String telefono, int idTipologiaSexo, byte[] imagen) {
		this.id = id;
		this.nombre = nombre;
