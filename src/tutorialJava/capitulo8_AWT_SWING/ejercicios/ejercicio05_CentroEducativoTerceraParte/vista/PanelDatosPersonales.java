...
public class PanelDatosPersonales extends JPanel {
	...
	public PanelDatosPersonales() {
		...
		scrollPane.addMouseListener(new MouseAdapter() {
            ...
            private void showPopup(MouseEvent e) {
            	...
            	if (imagenEnBytes != null && imagenEnBytes.length > 0) {
            		...
            		JMenuItem item = new JMenuItem("Dimensiones de la imagen: " + 
            				icono.getIconWidth() + " x " + icono.getIconHeight());
            		popup.add(item);
            		popup.addSeparator();
            	}
		...
		gbc_jtfColor.anchor = GridBagConstraints.NORTH;
		...
		btnElegirColor.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				seleccionarColorPreferido();
			}
		});
		GridBagConstraints gbc_btnElegirColor = new GridBagConstraints();
		gbc_btnElegirColor.anchor = GridBagConstraints.NORTH;
		gbc_btnElegirColor.gridx = 2;
		gbc_btnElegirColor.gridy = 9;
		add(btnElegirColor, gbc_btnElegirColor);
	 ...
	 * 
	 */
	private void seleccionarColorPreferido () {
	 ...
	 * @param strColor
	 */
	public void setColorPreferido (String strColor) {
