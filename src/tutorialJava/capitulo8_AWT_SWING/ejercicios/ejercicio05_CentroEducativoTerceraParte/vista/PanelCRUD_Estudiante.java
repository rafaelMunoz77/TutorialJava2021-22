...
import tutorialJava.capitulo8_AWT_SWING.ejercicios.ejercicio05_CentroEducativoTerceraParte.controladores.ControladorEstudiante;
import tutorialJava.capitulo8_AWT_SWING.ejercicios.ejercicio05_CentroEducativoTerceraParte.entidades.Estudiante;
...
public class PanelCRUD_Estudiante extends JPanel {
	...
	private void mostrarEstudiante (Estudiante e) {
		if (e != null) {
			...
			this.panelDatosPersonales.setColorPreferido(e.getColorPreferido());
	...
	private void limpiarDatos() {
		...
		this.panelDatosPersonales.setColorPreferido("");
	}
	...
	private void guardar() {
		...
		e.setColorPreferido(this.panelDatosPersonales.getColorPreferido());
